...
var Auth0Client = function() {
    ...
    Auth0Client.prototype._getRedirectUri = function(context, default_uri) {
            ...
            return __generator(this, (function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    params = this._getParams(authorizeOptions, stateIn, nonceIn, code_challenge, this._getRedirectUri("buildAuthorizeUrl", redirect_uri));
            ...
            return __generator(this, (function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    code_challengeBuffer = _a.sent();
                    code_challenge = bufferToBase64UrlEncoded(code_challengeBuffer);
                    params = this._getParams(authorizeOptions, stateIn, nonceIn, code_challenge, this._getRedirectUri("loginWithPopup", this.options.redirect_uri || window.location.origin));
            ...
            return __generator(this, (function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    params = this._getParams(withoutClientOptions, stateIn, nonceIn, code_challenge, this._getRedirectUri("_getTokenFromIFrame", options.redirect_uri || this.options.redirect_uri || window.location.origin));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(_a) {
                switch (_a.label) {
                  ...
                  case 4:
                    redirect_uri = this._getRedirectUri("_getTokenUsingRefreshToken", options.redirect_uri || this.options.redirect_uri || window.location.origin);
